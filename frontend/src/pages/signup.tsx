  ...
  return (
    <main className="min-h-screen bg-transparent px-4 py-6 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto grid min-h-[calc(100vh-3rem)] w-full max-w-6xl items-center gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        {/*<section className="overflow-hidden rounded-xl border border-white/10 bg-white/8 p-8 shadow-[0_25px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl sm:p-10">*/}
        ...
        <section className="rounded-sm border border-white/10 bg-slate-950/70 p-6 shadow-[0_25px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:p-8">
          <div className="flex rounded-sm border border-white/10 bg-white/5 p-1 text-sm font-medium text-slate-300">
            ...
            <button
              type="button"
              className="flex-1 rounded-sm bg-emerald-500 px-4 py-2.5 text-white shadow-lg shadow-emerald-500/20 transition"
              aria-current="page"
            >
              Sign up
            </button>
          ...
          <form className="mt-6 grid gap-4" onSubmit={submit}>
            ...
            <label className="grid gap-2 text-sm font-medium text-slate-200">
              Full name
              <input
                className="rounded-sm border border-white/10 bg-white/5 px-4 py-3 text-slate-100 outline-none transition placeholder:text-slate-500 focus:border-emerald-400/60 focus:bg-white/10 focus:ring-4 focus:ring-emerald-500/10"
                type="text"
                value={name}
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 inline-flex items-center justify-center rounded-sm bg-emerald-500 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-emerald-500/20 transition hover:bg-emerald-400 disabled:cursor-not-allowed disabled:opacity-60"
            >
